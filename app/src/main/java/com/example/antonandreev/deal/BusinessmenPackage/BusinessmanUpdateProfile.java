...
public class BusinessmanUpdateProfile extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.activity_businessman_update_profile);
    ...
    private void showPopupMenu(View v) {
        ...
        menu.inflate(R.menu.menu_businessman_update_profile);
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.btn_update_prof){
            ...
            try{
                ...
                Toast.makeText(BusinessmanUpdateProfile.this, "Success", Toast.LENGTH_SHORT).show();
            }catch (Exception e){
                Toast.makeText(BusinessmanUpdateProfile.this, "Error", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void writeNewFirstName(String userId, String firstname) {
        ...
        mDatabase.child("users").child("Businessmen").child(userId).child("FirstName").setValue(user);
    }
    ...
    private void writeNewSecondName(String userId, String secondname) {
        ...
        mDatabase.child("users").child("Businessmen").child(userId).child("SecondName").setValue(user);
    }
    ...
    private void writeNewTelephone(String userId, String telephone) {
        ...
        mDatabase.child("users").child("Businessmen").child(userId).child("Telephone").setValue(user);
    }
}
